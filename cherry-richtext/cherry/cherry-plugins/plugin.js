(function () {
    ...
    var CherryMindmapDialogHelper = function () {
      function CherryMindmapDialogHelper() {
        ...
        window.addEventListener('message', function (event) {
          ...
          case 'GET_MINDMAP_DATA:SUCCESS':
            _this.onSure(_this.encodeJSON(event.data.value.jsonData), event.data.value.base64Data);
            break;
          }
        }, false);
      }
      ...
      CherryMindmapDialogHelper.prototype.onSure = function (jsonData, base64Data) {
        var _this = this;
        var self = this;
        var imageTarget = this.target;
    ...
    var editIcon = '<svg width="12" height="12" version="1.1" id="\u56fe\u5c42_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"\nviewBox="0 0 850.394 850.394" enable-background="new 0 0 850.394 850.394" xml:space="preserve">\n<g>\n<path fill="#040000" d="M815.508,395.197c-16.568,0-30,13.432-30,30v362.75H60V62.446h405.623c16.568,0,30-13.432,30-30\n   s-13.432-30-30-30H59.094C26.51,2.446,0,28.955,0,61.539v727.315c0,32.584,26.509,59.093,59.094,59.093h727.32\n   c32.584,0,59.094-26.509,59.094-59.093V425.197C845.508,408.628,832.076,395.197,815.508,395.197z"/>\n<path fill="#040000" d="M243.748,609.093c5.858,5.858,13.536,8.787,21.213,8.787s15.355-2.929,21.213-8.787L841.606,53.661\n   c11.716-11.716,11.716-30.711,0-42.427c-11.715-11.716-30.711-11.716-42.426,0L243.748,566.667\n   C232.032,578.383,232.032,597.377,243.748,609.093z"/>\n</g>\n</svg>';
    ...
    var chooseWorkItemLogo = '<svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" >\n  <path d="M9.73331 15.3333C9.49269 15.3608 9.248 15.375 9 15.375C5.47918 15.375 2.625 12.5208 2.625 9C2.625 5.47918 5.47918 2.625 9 2.625C12.5208 2.625 15.375 5.47918 15.375 9C15.375 9.248 15.3608 9.49269 15.3333 9.73331L16.4102 10.1641C16.4693 9.78472 16.5 9.39594 16.5 9C16.5 4.85786 13.1421 1.5 9 1.5C4.85786 1.5 1.5 4.85786 1.5 9C1.5 13.1421 4.85786 16.5 9 16.5C9.39594 16.5 9.78472 16.4693 10.1641 16.4102L9.73331 15.3333Z" fill="#182B50"/>\n  <path d="M11.501 8.2004C11.1628 7.14166 10.1709 6.375 9 6.375C7.55025 6.375 6.375 7.55025 6.375 9C6.375 10.1709 7.14166 11.1628 8.2004 11.501L8.69511 12.7378C6.76664 12.5826 5.25 10.9684 5.25 9C5.25 6.92893 6.92893 5.25 9 5.25C10.9684 5.25 12.5826 6.76664 12.7378 8.69512L11.501 8.2004Z" fill="#182B50"/>\n  <path d="M8.60225 8.60225C8.76136 8.44314 8.99998 8.39416 9.20891 8.47773L16.7089 11.4777C16.9146 11.56 17.0528 11.7553 17.062 11.9766C17.0712 12.1979 16.9497 12.4041 16.7516 12.5031L13.9193 13.9193L12.5031 16.7516C12.4041 16.9497 12.1979 17.0712 11.9766 17.062C11.7553 17.0528 11.56 16.9146 11.4777 16.7089L8.47773 9.20891C8.39416 8.99998 8.44314 8.76136 8.60225 8.60225ZM10.0097 10.0097L12.0571 15.1281L12.9969 13.2484C13.0513 13.1396 13.1396 13.0513 13.2484 12.9969L15.1281 12.0571L10.0097 10.0097Z" fill="#182B50"/>\n</svg>';
    ...
    function registryPlugin (editor) {
      ...
      var insertTableEvent = function () {
        editor.editorContainer.getElementsByClassName('tox-insert-table-picker')[0].addEventListener('click', function (e) {
      ...
      var openGrid = function () {
        ...
        adjustEdge();
        var grid = '<div role="menu" class="tox-menu tox-collection tox-collection--list" style="position: absolute; left: ' + left + 'px; top: ' + top + 'px; overflow: hidden auto;z-index: 2000;">\n                 <div class="tox-collection__group">\n                     <div class="tox-fancymenuitem tox-menu-nav__js">\n                         <div class="tox-insert-table-picker" style="width: ' + gridWidth + 'px">\n                            ' + inner + '\n                         </div>\n                     </div>\n                 </div>\n            </div>';
