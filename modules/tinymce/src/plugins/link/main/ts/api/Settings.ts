...
const isGray = (editor: Editor): boolean => editor.getParam('linkGray', true, 'boolean');

const getToolbarItems = (editor: Editor): string => editor.getParam('link_toolbar', 'cardlink normallink insidelink | deletelink copylink openlink');
