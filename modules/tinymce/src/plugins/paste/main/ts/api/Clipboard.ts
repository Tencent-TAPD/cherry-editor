...
import {
  ClipboardContents, getDataTransferItems, hasContentType, hasHtmlOrText, pasteHtml, pasteImageData, pasteText, registerEventsAndFilters, pasteImageOrVideoData
} from '../core/Clipboard';
...
export interface Clipboard {
  ...
  pasteImageOrVideoData: (e: ClipboardEvent | DragEvent, rng: Range) => boolean;
...
export const Clipboard = (editor: Editor, pasteFormat: Cell<string>): Clipboard => {
  ...
  return {
    ...
    pasteImageOrVideoData: (e: ClipboardEvent | DragEvent, rng: Range) => pasteImageOrVideoData(editor, e, rng),
