...
const isSmartPasteALinkEnabled = (editor: Editor): boolean => editor.getParam('smart_paste_a_link', true);

const isSmartPasteImageLinkEnabled = (editor: Editor): boolean => editor.getParam('smart_paste_image_link', true);
...
const getFilePickerCallback = function (editor: Editor) {
  return editor.getParam('file_picker_callback');
};
const getVideoTemplateCallback = function (editor: Editor) {
...
export {
  ...
  shouldMergeFormats,
  isSmartPasteEnabled,
  isSmartPasteALinkEnabled,
  isSmartPasteImageLinkEnabled,
